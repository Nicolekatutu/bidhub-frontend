  ...
  <div className="mt-12 mx-auto px-12 md:px-16 lg:px-20 ml-24 mr-20 font-roboto">
    <div className="flex flex-col md:flex-row">
      ...
      <div className="md:w-2/3 mt-0 pl-8">
        ...
        <Link to="/register">
        <button className="bg-blue-600 text-white py-2 w-full mt-2 font-roboto">Sign in to bid</button>
        <button className="border border-blue-500 text-blue-500 py-2 w-full mt-4 font-roboto">Sign in to watch</button>
        </Link>
      </div>
    </div>
